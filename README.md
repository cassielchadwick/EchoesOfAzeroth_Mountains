...
This plugin will not load correctly on its own.

## Included music packs
...
1. Install `EchoesOfAzeroth`
2. Install this plugin
3. Open `/eoa options`
4. Enable the plugin in `Plugins`
5. Adjust mappings in `Zone Mapping` if desired
